                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                {currentProduct.badge ? (
                                    <span className="inline-block mt-1 bg-black text-white px-3 py-1 rounded-full text-xs font-bold">
                                        {currentProduct.badge}
                                    </span>
                                ) : (
                            ...
                            <div>
                                ...
                                <div className="flex gap-2 mt-1">
                                    ...
                                    {currentProduct.isFeatured && (
                                        <span className="bg-purple-100 text-purple-700 px-3 py-1 rounded-full text-xs font-bold">Featured</span>
                                    )}
                                </div>
                            </div>
                        </div>
                ...
                {variants.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {variants.map((variant) => (
                            <div
                                key={variant._id}
                                className="border border-slate-200 rounded-2xl p-4 hover:border-black transition-colors cursor-pointer"
                                onClick={() => {
                            ...
                            >
                                ...
                                <div className="space-y-2">
                                    <div className="flex items-center justify-between">
                                        ...
                                        {variant.isDefault && (
                                            <span className="bg-black text-white px-2 py-0.5 rounded text-xs font-bold">Default</span>
                                        )}
                                    </div>
