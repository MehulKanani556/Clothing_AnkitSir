    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 text-sm">Manage your top-level clothing categories here.</p>
        </div>
        <button 
          onClick={() => {
            setEditingCategory(null);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-black p-5 rounded-3xl border border-black flex items-center justify-between shadow-xl shadow-black/10">
            <div>
                ...
                <p className="text-3xl font-black text-white">{mainCategories.length}</p>
            </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-50/50 border-b border-slate-100">
                ...
                <th className="px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider">Category Details</th>
              ...
              {loading && mainCategories.length === 0 ? (
                ...
                paginatedCategories.map((category, index) => (
                  <tr key={category._id} className="hover:bg-slate-50/50 transition-colors group">
                    ...
                    <td className="px-6 py-4">
                      <span className="font-bold text-slate-900 text-base">{category.mainCategoryName}</span>
                    </td>
