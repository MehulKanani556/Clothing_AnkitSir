        ...
        <div className="grid grid-cols-1 gap-6">
          <div className="space-y-1.5">
            ...
            <input
              ...
              className={`w-full px-5 py-3.5 rounded-2xl border transition-all outline-none text-sm font-medium ${formik.touched.subCategoryName && formik.errors.subCategoryName
