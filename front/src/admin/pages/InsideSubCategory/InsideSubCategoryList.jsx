  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        >
          <MdAdd size={20} />
          <span>Add New Inside Sub Category</span>
        </button>
      </div>
              ...
              {loading && insideSubCategories.length === 0 ? (
                ...
                paginatedCategories.map((category) => (
                  <tr key={category._id} className="hover:bg-slate-50/50 transition-colors group">
                    ...
                    <td className="px-6 py-4">
                      <span className="font-bold text-slate-900 text-base">{category.insideSubCategoryName}</span>
                    </td>
                    <td className="px-6 py-4">
                      <span className="text-sm text-slate-600">{category.subCategoryId?.subCategoryName || 'N/A'}</span>
                    </td>
